...
export default class Ride {
	...
	private constructor (readonly rideId: string, readonly passengerId: string, public driverId: string | null, private segment: Segment, status: string, readonly date: Date) {
	...
	static restore (rideId: string, passengerId: string, driverId: string | null, fromLat: number, fromLong: number, toLat: number, toLong: number, status: string, date: Date) {
